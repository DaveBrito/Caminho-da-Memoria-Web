...
function mudarTexto() {
    ...
    const palavraAntiga = "Memórias"; // Palavra a ser substituída
    const novaPalavra1 = "Lembranças"; // Nova palavra a ser adicionada
    const novaPalavra2 = "Recordações"; // Segunda nova palavra a ser adicionada

    // Define um pequeno atraso antes de iniciar a animação
    setTimeout(() => {
        // Animação para apagar a palavra "Usuário"
